...
export const siteConfig: SiteConfig = {
  ...
  portfolio: [
    ...
    {
      name: "Rede Brasil Solar",
      niche: "Energia Solar",
      description: "Catálogo de kits residenciais e comerciais, com CTA de simulação grátis.",
      icon: "☀️",
      url: "",
    },
    {
      name: "Dutra Máquinas e Motores",
      niche: "Manutenção Industrial",
      description: "Site institucional com serviços de manutenção preventiva e corretiva.",
      icon: "⚙️",
      url: "",
    },
    {
      name: "Construtora Camobi",
